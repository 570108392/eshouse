package it.qsbl.com.aop;

import it.qsbl.com.annotation.Log;
...
public class LogAspect {
    ...
    public Object doAround(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        log.info("调用方法开始: {}  路径为URL: {}", LocalDateTime.now(),uri);
        //访问目标方法的参数 可动态改变参数值
        ...
        log.info("调用方法结束: {},  URI: {},耗时：{}", LocalDateTime.now(),uri,endTime - beginTime);
        //模拟异常
