...
public class ESUtil {
    ...
    public ESUtil() {
        client = new RestHighLevelClient(
                RestClient.builder(
                        new HttpHost("129.204.182.56", 9300, "http")).setDefaultHeaders(new Header[]{}));
    }
    ...
    public void addData(String indexName, String type, String id, String jsonStr) {
        try {
            ...
            IndexRequest request = new IndexRequest(indexName, type);    //文档id
            // 2、准备文档数据
            // 直接给JSON串
    ...
    public static void main(String ags[]) throws JsonProcessingException {
        ...
        esUtil.bulkDate("goodsinfo", "goodsCommodity", "id", list);*/
//    Map<String,Object> map = new HashMap<String, Object>();
...
//        "}");
        ...
        esUtil.addData("zhangpeng","myIndex","111",str);
    }
